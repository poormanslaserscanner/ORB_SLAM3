...
void MapPoint::PreSave(set<KeyFrame*>& spKF,set<MapPoint*>& spMP)
{
    ...
    std::map<KeyFrame*,std::tuple<int,int> >::const_iterator next_it = mObservations.begin();
    for(std::map<KeyFrame*,std::tuple<int,int> >::const_iterator it = next_it, end = mObservations.end(); it != end; it = next_it)
    {
        next_it = it;
        ++next_it;
